const Compte = {
  ...
  icalTitle: "Calendario Airbnb (iCal)",
  icalLead:
    "Exporte este enlace en Airbnb (Importar calendario) y pegue aquí el iCal de Airbnb para bloquear las noches ocupadas.",
  icalExport: "Enlace para pegar en Airbnb:",
  icalImport: "Enlace iCal Airbnb (importación)",
  icalSave: "Guardar",
  ...
  badgeCheckIn: "Check-in hecho",
  badgeClean: "Limpieza hecha",
  stayDelete: "Eliminar",
  ...
  historyLead:
    "En cuanto el equipo registra un check-in o una limpieza, las pastillas aparecen aquí y en el calendario.",
  historyCurrent: "En curso y próximas",
  historyPast: "Estancias pasadas",
  historyEmpty: "Aún no hay estancias.",
