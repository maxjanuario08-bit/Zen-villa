export const ownerServices = {
  "check-in": {
    ...
    description:
      "Accueil personnalisé de vos voyageurs à leur arrivée et accompagnement lors de leur départ. Nous assurons la remise des clés, la visite des lieux et les consignes de la villa.",
    details: [
  ...
  menage: {
    ...
    description:
      "Un ménage soigné après chaque séjour pour préserver votre villa. Équipe professionnelle, produits de qualité et linge de maison géré.",
    details: [
  ...
  reservations: {
    ...
    description:
      "Gestion complète de votre calendrier et de vos réservations sur Airbnb, Booking, Abritel et autres plateformes. Réponses aux voyageurs 7j/7.",
    details: [
      "Synchronisation des calendriers",
      "Gestion des demandes et confirmations",
      "Réponses aux voyageurs dans les délais",
      "Calendriers alignés avec vos préférences saisonnières",
    ],
  },
  maintenance: {
    label: "Maintenance des villas",
    description:
      "Entretien préventif et dépannage rapide pour maintenir votre villa en parfait état. Réseau d'artisans de confiance en Corse Sud.",
    details: [
  ...
  activites: {
    ...
    description:
      "Proposition et organisation d'activités pour les voyageurs : sorties en mer, balades à cheval, livraison de courses, location de matériel.",
    details: [
  ...
  assistance: {
    ...
    description:
      "Une équipe locale disponible tous les jours pour vos voyageurs et pour vous. Joignables par téléphone pour toute question ou urgence.",
    details: [
