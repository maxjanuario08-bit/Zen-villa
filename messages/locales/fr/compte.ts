const Compte = {
  ...
  badgeCheckIn: "Check-in fait",
  badgeClean: "Ménage fait",
  ...
  historyLead:
    "Dès que l’équipe enregistre un check-in ou un ménage, les pastilles apparaissent ici et sur le calendrier.",
  historyCurrent: "En cours et à venir",
  historyPast: "Séjours passés",
  historyEmpty: "Aucune location pour le moment.",
