const Compte = {
  ...
  icalTitle: "Airbnb calendar (iCal)",
  icalLead:
    "Paste the export link into Airbnb (Import calendar) and paste Airbnb’s iCal URL here to block nights already taken.",
  icalExport: "Link to paste in Airbnb:",
  icalImport: "Airbnb iCal link (import)",
  icalSave: "Save",
  ...
  badgeCheckIn: "Check-in done",
  badgeClean: "Cleaning done",
  stayDelete: "Delete",
  ...
  historyLead:
    "As soon as the team records a check-in or a cleaning, the badges show here and on the calendar.",
  historyCurrent: "Current and upcoming",
  historyPast: "Past stays",
  historyEmpty: "No stays yet.",
