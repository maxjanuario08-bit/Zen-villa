...
export const metadata: Metadata = {
  title: "Packs – Zen Tranquillité & Zen Premium",
  description:
  ...
  openGraph: {
    ...
    description:
      "Packs conciergerie pour propriétaires : essentiel ou gestion complète avec annonces et réservations.",
  },
};
...
const packs = [
  ...
  },
  {
    ...
    description: "Pour une gestion clé en main : annonces, calendriers et voyageurs suivis avec soin.",
    inclus: [
